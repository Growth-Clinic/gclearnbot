LESSON_FEEDBACK_RULES = {
    # Lesson 2 - Design Thinking (already done)
    "lesson_2_step_1": {  # Empathise
        "criteria": {
    ...
    "lesson_2_step_6": {  # Test and Improve
        "criteria": {
            "Feedback Collection": {
    ...
    "lesson_3_step_1": {  # What is a Business Model?
        "criteria": {
    ...
    "lesson_3_step_2": {  # Business Model Canvas
        "criteria": {
            "Canvas Completion": {
    ...
    "lesson_3_step_3": {  # Prototyping Your Business Model
        "criteria": {
            "Model Variation": {
    ...
    "lesson_3_step_4": {  # Testing Your Model
        "criteria": {
            "Assumption Testing": {
    ...
    "lesson_3_step_5": {  # Navigating the Business Environment
        "criteria": {
    ...
    "lesson_3_step_6": {  # Telling Your Story
        "criteria": {
            "Storytelling": {
    ...
    "lesson_4_step_1": {  # Build on Your Product-Market Fit
        "criteria": {
    ...
    "lesson_4_step_2": {  # Market-Channel Fit
        "criteria": {
    ...
    "lesson_4_step_3": {  # Channel-Model Fit
        "criteria": {
    ...
    "lesson_4_step_4": {  # Model-Market Fit
        "criteria": {
    ...
    "lesson_4_step_5": {  # Putting It All Together
        "criteria": {
            "Growth Plan Clarity": {
    ...
    "lesson_5_step_1": {  # Understanding Emotions
        "criteria": {
            "Emotional Insight": {
    ...
    "lesson_5_step_2": {  # Introducing the Hooked Model
        "criteria": {
    ...
    "lesson_5_step_3": {  # Applying the Hooked Model
        "criteria": {
    ...
    "lesson_5_step_4": {  # Case Study - Amazon’s Alexa
        "criteria": {
            "Case Study Analysis": {
    ...
    "lesson_5_step_5": {  # A Deeper Dive into Behavior Models
        "criteria": {
    ...
    "lesson_6_step_1": {  # Agile Methodologies Overview
        "criteria": {
    ...
    "lesson_6_step_2": {  # Scope Your Work
        "criteria": {
            "Scope Clarity": {
    ...
    "lesson_6_step_3": {  # Create Milestones
        "criteria": {
    ...
    "lesson_6_step_5": {  # Prioritise Tasks
        "criteria": {
            "Task Prioritization": {
    ...
    "lesson_6_step_6": {  # Create Sprints
        "criteria": {
            "Sprint Planning": {
    ...
    "lesson_6_step_7": {  # Review and Reflect
        "criteria": {
            "Progress Review": {
